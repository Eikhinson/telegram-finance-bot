...
import { L as LoadAPIKeyError$1, b as InvalidArgumentError$1, c as TypeValidationError$1, A as APICallError$1, E as EmptyResponseBodyError$1, J as JSONParseError$1, d as EventSourceParserStream$1, U as UnsupportedFunctionalityError$1, N as NoSuchModelError, T as TooManyEmbeddingValuesForCallError, I as InvalidResponseDataError$1, a as InvalidPromptError$1 } from './stream.mjs';
import { v as safeParseAsync, w as toJSONSchema, o as object, s as string, b as boolean, c as array, u as union, d as literal, n as number, A as looseObject, f as discriminatedUnion, e as unknown, r as record, _ as _enum, B as tuple, a as any, l as lazy, C as nativeEnum } from './schemas.mjs';
import { Z as ZodFirstPartyTypeKind } from './v3.mjs';
import { n as number$1 } from './coerce.mjs';
import { M as MastraBase } from './chunk-VQASQG5D.mjs';
...
var CACHE_DIR = () => path.join(require$$1.homedir(), ".cache", "mastra");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway } = await import('./models-dev-LJ4O6FNF.mjs');
      const { NetlifyGateway } = await import('./netlify-L7AZ74PV.mjs');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-I6S4ARS6.mjs');
  ...
  try {
    const response = await fetch(url, {
      ...
      headers: withUserAgentSuffix$7(
        headers,
        `ai-sdk/provider-utils/${VERSION$d}`,
...
function createOpenAICompatible(options) {
  ...
  const getHeaders = () => withUserAgentSuffix$4(headers, `ai-sdk/openai-compatible/${VERSION$6}`);
...
var CommonReasoningDetailSchema = object({
  id: string().nullish(),
  format: nativeEnum(ReasoningFormat).nullish(),
...
var OpenRouterProviderOptionsSchema = object({
  openrouter: object({
    reasoning_details: array(ReasoningDetailUnionSchema).optional()
  }).optional()
}).optional();
...
var OpenRouterNonStreamChatCompletionResponseSchema = union([
...
export { GatewayRegistry as G, InMemoryServerCache as I, ModelRouterLanguageModel as M, NetlifyGateway as N, PROVIDER_REGISTRY as P, ModelsDevGateway as a, ModelRouterEmbeddingModel as b, getProviderConfig as g, resolveModelConfig as r };
//# sourceMappingURL=chunk-72F4RGK7.mjs.map
