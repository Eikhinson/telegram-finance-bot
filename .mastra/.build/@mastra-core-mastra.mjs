import { W as WorkflowEventProcessor } from './chunk-2BY7C6Y7.mjs';
...
import { I as InMemoryServerCache } from './chunk-72F4RGK7.mjs';
import { r as registerHook } from './hooks.mjs';
import { s as setupAITracing, a as getAllAITracing, b as shutdownAITracingRegistry } from './chunk-PPAIPZ6C.mjs';
import 'stream';
import { M as MastraError } from './error.mjs';
import { L as LogLevel, C as ConsoleLogger } from './chunk-VQASQG5D.mjs';
import { _ as __decoratorStart, h as __decorateElement, i as __runInitializers } from './chunk-Y2BH2LUD.mjs';
...
`
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-7BUYRBGO.mjs').then(async ({
        GatewayRegistry
      }) => {
...
export { Mastra };
//# sourceMappingURL=@mastra-core-mastra.mjs.map
